    ...
    if st.button(
        ...
        if not comment.strip():
            ...
            if toxic_found:
                ...
                st.error(
                    "⚠️ This comment may contain toxic content."
                )

            else:

                st.success(
                    "✅ This comment appears to be non-toxic."
                )
...
# =========================================================
    ...
    st.write(
        ...
        and Deep Learning to identify toxic comments.
    ...
    st.info(
        ...
        "machine-learning content moderation prototype."
    )